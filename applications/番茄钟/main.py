...
class MainPage(lib.Pages.PageWithTitle):
    def __init__(self, book):
        ...
        self.status_text = lib.Elements.Label(self, (0, 90), (114, 12), text="开始计时", align="C")
        self.add_element(self.status_text)
        self.add_element(lib.Elements.ImageButton(self, (0, 30), (114, 266), self.control))
        self.clock = lib.Elements.Label(self, (114, 58), (182, 36), text="00:00", font_size=36, align="C")
        self.add_element(self.clock)
        self.text_count = lib.Elements.Label(self, (114, 112), (182, 12), text=f"共获得{self.tomato}个番茄", align="C")
